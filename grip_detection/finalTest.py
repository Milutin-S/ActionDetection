...
# model.load_weights('weights/final/45/3x10/7/my_best_model.epoch82-loss0.04.h5')
...
##
# model.load_weights('weights/final/45/3x30/4/my_best_model.epoch85-loss0.02.h5')
# model.load_weights('weights/final/45/3x30/7/my_best_model.epoch89-loss0.01.h5')
...
# model.load_weights('weights/final/45/3x60/7/my_best_model.epoch90-loss0.01.h5')
# model.load_weights('weights/final/45/3x60/10/my_best_model.epoch89-loss0.00.h5')
###
# model.load_weights('weights/final/60/3x10/4/my_best_model.epoch89-loss0.02.h5')
# model.load_weights('weights/final/60/3x10/7/my_best_model.epoch88-loss0.01.h5')
# model.load_weights('weights/final/60/3x10/10/my_best_model.epoch90-loss0.00.h5')
##
# model.load_weights('weights/final/60/3x30/4/my_best_model.epoch87-loss0.02.h5')
# model.load_weights('weights/final/60/3x30/7/my_best_model.epoch89-loss0.01.h5')
# model.load_weights('weights/final/60/3x30/10/my_best_model.epoch86-loss0.00.h5')
##
# model.load_weights('weights/final/60/3x60/4/my_best_model.epoch86-loss0.03.h5')
# model.load_weights('weights/final/60/3x60/7/my_best_model.epoch89-loss0.01.h5')
# model.load_weights('weights/final/60/3x60/10/my_best_model.epoch86-loss0.01.h5')
###
# model.load_weights('weights/final/75/3x10/4/my_best_model.epoch89-loss0.03.h5')
# model.load_weights('weights/final/75/3x10/7/my_best_model.epoch85-loss0.01.h5')
# model.load_weights('weights/final/75/3x10/10/my_best_model.epoch73-loss0.01.h5')
##
# model.load_weights('weights/final/75/3x30/4/my_best_model.epoch77-loss0.02.h5')
# model.load_weights('weights/final/75/3x30/7/my_best_model.epoch71-loss0.01.h5')
# model.load_weights('weights/final/75/3x30/10/my_best_model.epoch85-loss0.00.h5')
##
# model.load_weights('weights/final/75/3x60/4/my_best_model.epoch88-loss0.02.h5')
# model.load_weights('weights/final/75/3x60/7/my_best_model.epoch84-loss0.01.h5')
# model.load_weights('weights/final/75/3x60/10/my_best_model.epoch63-loss0.01.h5')

# model.load_weights('weights/final/big/4/my_best_model.epoch85-loss0.02.h5')
# model.load_weights('weights/final/big/7/my_best_model.epoch89-loss0.01.h5')

# model.load_weights('weights/final/45/3x60/additional/45_4_180e/my_best_model.epoch174-loss0.01.h5')
# model.load_weights('weights/final/60/3x60/additional/60_7_180e/my_best_model.epoch176-loss0.01.h5')
...
# model.load_weights('weights/final/75/full_7_rest_fix/my_best_model.epoch89-loss0.01.h5')
model.load_weights('weights/final/75/full_7_rest_fix/my_best_model.epoch169-loss0.01.h5')
...
resNull = np.zeros(len(actions))

print("res:", res)
forPlot = []

for ctr in range(window_length):
    forPlot.append(resNull)

cap = cv2.VideoCapture('test/good/view_3/testMulti.avi')
length = int(cap.get(cv2.CAP_PROP_FRAME_COUNT))
print(length)
# fourcc = cv2.VideoWriter_fourcc(*'XVID')
# out = cv2.VideoWriter('test/view_3/testMulti.avi', fourcc, 30, (640, 480))
...
with mp_hands.Hands(max_num_hands= 1, model_complexity=0, min_detection_confidence=0.5, min_tracking_confidence=0.5) as hands:
    while cap.isOpened():
        ...
        # 480 x 640
        ret, frame = cap.read()
        # frameVid = cv2.flip(frame, 1)
        # print(frame.shape) check
        # Make detections
        image, results = mediapipe_detection(frame, hands) # right hand
        # image, results = mediapipe_detection(cv2.flip(frame, 1), hands) # left hand
        # print(results)
        ...
        # cv2.putText(frameVid, 'Frame: {}'.format(i), (15, 20),
        ...
        if (cv2.waitKey(5) & 0xFF == 27) or (i == (length-1)):
            # print("RES PART: ", forPlot[2])
