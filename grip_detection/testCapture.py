...
# model.load_weights('weights/final/75/3x60/7#3/my_best_model.epoch86-loss0.02.h5')
model.load_weights('weights/final/45/3x10/4/my_best_model.epoch82-loss0.04.h5')
...
out = cv2.VideoWriter('test/good/view_3/testMulti.avi', fourcc, 30, (640, 480))
...
with mp_hands.Hands(max_num_hands= 1, model_complexity=0, min_detection_confidence=0.5, min_tracking_confidence=0.5) as hands:
    while cap.isOpened():
        ...
        # Make detections
        image, results = mediapipe_detection(frameVid, hands) # right hand
